...
w = np.array([0.059539720, 0.063697663, 0.068544221, 0.072845984, 0.076362742, 0.079110300, 0.081160293, 0.082590932, 0.083483575])
N = len(w)
k = w2k(w)
w = w.reshape((N, 1))
x = np.zeros(N)
...
plt.title(r"shear waves (tanh)")

name = f"tanh_shear_l{l}_h{h}"
