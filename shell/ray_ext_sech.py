...
w = np.array([0.100539755, 0.101872402, 0.103473972, 0.105111571, 0.106747444, 0.108317157, 0.109774841, 0.111082180])
N = len(w)
k = w2k(w)
w = w.reshape((N, 1))
x = np.zeros(N)
...
plt.title(r"extensional waves (sech)")

name = f"sech_ext_l{l}_h{h}"
